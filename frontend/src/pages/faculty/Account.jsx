...
const Account = () => {
  ...
  useEffect(() => {
    if (currentUser) {
      setFormData({
        faculty_id: currentUser.employee_id || currentUser.faculty_id || "",
  ...
  const fullName = rawFullName ? capitalise(rawFullName) : "Faculty User";
              ...
              <Box display="flex" alignItems="center" gap={2}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {capitalise(formData.position || "Professor")}
                  </Typography>
                </Box>
              </Box>
              ...
              <Grid container spacing={3}>
                ...
                <Grid xs={12} md={6}>
                  <TextField
                    label="Position"
                    name="position"
                    value={capitalise(formData.position || "Professor")}
                    onChange={handleChange}
                    fullWidth
                    disabled={!isEditing}
                    InputProps={{
