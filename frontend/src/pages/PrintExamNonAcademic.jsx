...
const PrintExamNonAcademic = () => {
  ...
  const employeeId = (profile && profile.employee_id) || exam.employee_id || exam.user_employee_id || '';
  ...
  const department = (profile && profile.department) || exam.department || '';
  ...
  return (
    <div className="print-root">
      ...
      <button 
        ...
        onClick={() => navigate('/non-academic/health-records')}
      >
        ← Go Back
      </button>
      <div className="container">
        ...
        {/* NON-ACADEMIC STAFF INFO HEADER */}
        <div style={{marginBottom: '20px', borderBottom: '1px solid #ccc', paddingBottom: '12px'}}>
          <h2 style={{margin: '0 0 12px 0', fontSize: '16px'}}>NON-ACADEMIC STAFF INFORMATION</h2>
          <div className="row">
...
export default PrintExamNonAcademic;
