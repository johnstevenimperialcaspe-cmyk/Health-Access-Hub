    ...
    <Box>
      ...
      <Grid container spacing={2} sx={{ mb: 2 }}>
        <Grid xs={12} md={6}>
          <TextField
            fullWidth
            placeholder="Search records by type, diagnosis, or complaint..."
            value={searchTerm}
      ...
      >
                  ...
                  <>
                    ...
                    <Grid xs={12}>
                      ...
                      <Grid container spacing={2}>
                        ...
                        {/* Respiratory Rate removed from details */}
                      </Grid>
                    </Grid>
                    <Divider sx={{ my: 2, width: "100%" }} />
                    <Grid xs={12}>
        ...
        <DialogActions>
          ...
          {selectedRecord && (
            <Button
              onClick={() => window.open(`/print/non-academic/${selectedRecord.id}`, "_blank")}
              variant="outlined"
            >
              Print
            </Button>
