  ...
  return (
    <div className="print-root">
      ...
      <button 
        ...
        onClick={() => navigate('/faculty/health-records')}
      >
        ← Go Back
      </button>
      <div className="container">
        ...
        <div style={{marginBottom: '20px', borderBottom: '1px solid #ccc', paddingBottom: '12px'}}>
          <h2 style={{margin: '0 0 12px 0', fontSize: '16px'}}>FACULTY INFORMATION</h2>
          <div className="row">
...
export default PrintExamFaculty;
